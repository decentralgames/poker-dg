...
var Dealer = /** @class */ (function () {
    ...
    Dealer.prototype.startHand = function () {
        ...
        if (playersWithChips.length > 1 || playersWithChips.length === 1 && bigBlindIsAllIn) {
            this._bettingRound = new betting_round_1.default(__spreadArray([], this._players), this._players.map(function (player) { return !!player; }), firstAction, this._forcedBets.blinds.big, this.blinds(), this._roundOfBetting, bigBlindIsAllIn ? biggestBet : this._forcedBets.blinds.big);
        }
    ...
    Dealer.prototype.endBettingRound = function () {
        ...
        if (((_b = (_a = this._bettingRound) === null || _a === void 0 ? void 0 : _a.numActivePlayers()) !== null && _b !== void 0 ? _b : 0) <= 1) {
            ...
            this._bettingRound = new betting_round_1.default(__spreadArray([], this._players), nonFoldedPlayers, this.nextOrWrap(this._button), this._forcedBets.blinds.big, this.blinds(), this._roundOfBetting);
            this.dealCommunityCards();
