...
describe('Poker facade', () => {
  ...
  describe('hand in progress', () => {
    ...
    test('side pot', () => {
      ...
      // dealer (0) raises to 400
      poker.actionTaken('raise', 400);

      // SB (1) matches 400 and raises additional 400
      // side pot of 400 created
      poker.actionTaken('raise', 800);

      // BB (2) calls 800; 400 more in main pot + 400 in side pot
